<template>
    <div id="repertoryReturnCheckList">
        ...
        <!--弹出窗口-->
        <el-input v-model="orderDate" placeholder="全部供应商" @focus="selectSupplier=true"></el-input>        
        <el-dialog
        title="选择供应商"
        ...
        <el-select v-model="value" placeholder="结算账户">
            <el-option
            v-for="item in options"
            :key="item.value"
            :label="item.label"
        ...
        <el-select v-model="value" placeholder="操作用户">
            <el-option
            v-for="item in options"
            :key="item.value"
            :label="item.label"
        ...
        <!--详情弹窗-->        
        <el-dialog width="80%" title="购货退货单详情" :visible.sync="dialogDetail">
            <!--供应商弹窗-->            
...
<style>
    ...
    #repertoryReturnCheckList .custM-header{
        text-align:left;
    }
