...
export default {
    ...
    methods:{
        ...
        edit(){//--------------修改
            this.formServeDetail.require_handle_time=this.dateConverter(this.formServeDetail.require_handle_time);
            this.formServeDetail.check_time=this.dateConverter(this.formServeDetail.check_time);
            this.formServeDetail.handle_time=this.dateConverter(this.formServeDetail.handle_time);
