    ...
    <div class="agencyStatements">
        ...
        <div class="main-header">
            ...
            <el-breadcrumb separator-class="el-icon-arrow-right">
                ...
                <el-breadcrumb-item>机构结算单</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        ...
        <div class="main-table">
            ...
            width="200px">
                <el-checkbox v-model="agencyStatshow.show1">单号</el-checkbox><br>
                <el-checkbox v-model="agencyStatshow.show2">分店名称</el-checkbox><br>
                <el-checkbox v-model="agencyStatshow.show3">机构</el-checkbox><br>
                <el-checkbox v-model="agencyStatshow.show4">结算价格</el-checkbox><br>
                <el-checkbox v-model="agencyStatshow.show5">优惠金额</el-checkbox><br>
                <el-checkbox v-model="agencyStatshow.show6">现金支付金额</el-checkbox><br>
                <el-checkbox v-model="agencyStatshow.show7">支付方式</el-checkbox><br>
                <el-checkbox v-model="agencyStatshow.show8">银行账号</el-checkbox><br>
                <el-checkbox v-model="agencyStatshow.show9">修改人姓名</el-checkbox><br>
                <el-checkbox v-model="agencyStatshow.show10">状态</el-checkbox><br>
                <el-checkbox v-model="agencyStatshow.show11">修改日期</el-checkbox><br>
                <el-checkbox v-model="agencyStatshow.show12">审核时间</el-checkbox><br>
                <el-checkbox v-model="agencyStatshow.show13">备注</el-checkbox><br><br>
            </el-dialog>
            <!-- 搜索 -->
            ...
            <!-- 详情弹出框 -->
            <el-dialog width="950px" title="结算信息" :visible.sync="dialogServeDetail">
            ...
            return String(data[key]).toLowerCase().indexOf(search) > -1})})"
                ...
                align="center"
                width="110"
                v-if="agencyStatshow.show3"
                label="机构">
                    <template slot-scope="scope">
                        <el-input v-model="scope.row.jigou_name" />
                    </template>
                </el-table-column>
                <el-table-column
                prop="jiesuan_price"
...
import {
  ...
  getAgencystatementDetail,
  addAgencystatement,
  editAgencystatement,
  checkAgencystatement
} from "../../api/api";
export default {
    data() {
        return {
    ...
    methods:{
        handleClose(done){
            ...
            erpTableSetting.agencyStat=this.agencyStatshow;
        ...
        initData() { //------------------获取列表
            ...
            getAgencystatementList(data).then(res=>{
                console.log(res.data)
                if(res.errno == 0) {
                    this.Data = res.data.agency_list
        ...
        edit(row){//-----------------------------修改
            ...
            editAgencystatement(data).then(res=>{
                if (res.errno == 0) {
                    this.$message({
                        type: "success",
                        message: "修改成功!",
        ...
        editDone(formName) {
            this.$refs[formName].validate(valid => {
                ...
                if (this.isEdit) {
                    ...
                    editAgencystatement(tmpData).then(res => {
                    if (res.errno == 0) {
                        this.$message({
                        type: "success",
                        message: "修改成功!",
                    ...
                    this.formServeDetail.check_time = parseInt(new Date() / 1000);
                    let tmpData = this.$qs.stringify(this.formServeDetail);
                    addAgencystatement(tmpData).then(res => {
                    if (res.errno == 0) {
                        this.$message({
                        type: "success",
                        message: "添加成功!",
        ...
        checkRow(row) {
            ...
            .then(() => {
                ...
                checkAgencystatement(tmpData).then(res=>{
                    if (res.errno == 0) {
                        this.$message({
                            type: "success",
                            message: "审核成功!",
        ...
        showDetails(row){
            ...
            getAgencystatementDetail(data).then(res => {
                if (res.errno == 0) {
                this.formServeDetail = res.data;
                this.formServeDetail.jiesuan_price = res.data.jiesuan_price.substring(1);
    ...
    created() {
        if(localStorage.erpTableSetting!==undefined){
            console.log("yes");
            let erpTableSetting=JSON.parse(localStorage.erpTableSetting); 
            if(erpTableSetting.agencyStat!==undefined){
                this.agencyStatshow=erpTableSetting.agencyStat;
            }
        }else{
            console.log("no");
        };
...
/* 新增弹出框 & 详情弹出框*/
.agencyStatements >>> .el-dialog__body {
  padding: 0 20px;
}
