    ...
    <div class="advanceCollection">
        ...
        <div class="main-table">
            ...
            <!-- <el-form :inline="true" :model="formServe" class="demo-form-inline">
                <el-form-item>
                    <el-input placeholder="请输入预收款单号" @input="search" v-model="keywords" style="width:50%;margin-right:10px" size="small">
                    ...
                    <el-row>
                        <el-col :span="8">
                            <el-form-item label="客户名">
                                <el-input :disabled="formServeDetail.status=='已审核'" v-model="formServeDetail.user_name" autocomplete="off"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="8">
                            <el-form-item label="业务单号">
                                <el-input :disabled="formServeDetail.status=='已审核'" v-model="formServeDetail.yewu_sn" autocomplete="off"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="8">
                            <el-form-item label="预收款单号">
                                <el-input :disabled="formServeDetail.status=='已审核'" v-model="formServeDetail.bill_sn" autocomplete="off"></el-input>
                            </el-form-item>
                        </el-col>
                    </el-row>
                    <el-row>
                        <el-col :span="8">
                            <el-form-item label="银行账号">
                                <el-input :disabled="formServeDetail.status=='已审核'" v-model="formServeDetail.bank_account" autocomplete="off"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="8">
                            <el-form-item label="支付方式">
                                <el-input :disabled="formServeDetail.status=='已审核'" v-model="formServeDetail.payment" autocomplete="off"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="8">
                    ...
                    <el-row>
                        ...
                        <el-col :span="8">
                            <el-form-item label="备注">
                                <el-input :disabled="formServeDetail.status=='已审核'" v-model="formServeDetail.remark" autocomplete="off"></el-input>
                            </el-form-item>
                        </el-col>
                    </el-row>
                    <el-row>
...
import {
  ...
  getAdvancecollectionDetail,
  addAdvancecollection,
  editAdvancecollection,
    ...
    methods:{
        ...
        this.$refs[formName].validate(valid => {
            ...
            if (this.isEdit) {
                ...
                // this.formServeDetail.check_time = parseInt(new Date() / 1000);
                let tmpData = this.$qs.stringify(this.formServeDetail);
                addAdvancecollection(tmpData).then(res => {
                if (res.errno == 0) {
                    this.$message({
                    type: "success",
                    message: "添加成功!",
        ...
        checkRow(row) {
            ...
            .then(() => {
                ...
                checkAdvancecollection(tmpData).then(res=>{
                    if (res.errno == 0) {
                        this.$message({
                            type: "success",
                            message: "审核成功!",
...
/* 新增弹出框 & 详情弹出框*/
.advanceCollection >>> .el-dialog__body {
  padding: 0 20px;
}
