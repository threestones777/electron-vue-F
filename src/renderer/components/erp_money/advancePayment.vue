    ...
    <div class="advancePayment">
        ...
        <div class="main-header">
            ...
            <el-breadcrumb separator-class="el-icon-arrow-right">
                ...
                <el-breadcrumb-item>供应商预付款</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
            ...
            <el-dialog width="950px" title="客户信息" :visible.sync="dialogServeDetail">
                <el-form :disabled="formServeDetail.status=='已审核'" label-position="left" ref="form" :model="formServeDetail" :inline="true" class="demo-form-inline">
                    <el-row>
                        ...
                        <el-col :span="8">
                            <el-form-item label="业务单号">
                                <el-input v-model="formServeDetail.yewu_sn" autocomplete="off"></el-input>
                            </el-form-item>
                        </el-col>
                    </el-row>
                    <el-row>
                        ...
                        <el-col :span="8">
                            <el-form-item label="用户账号">
                                <el-input v-model="formServeDetail.user_account" autocomplete="off"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="8">
                    ...
                    <el-row>
                        ...
                        <el-col :span="8">
                            <el-form-item label="已结金额" prop="yijie_money" :rules="rule">
                                <el-input-number v-model="formServeDetail.yijie_money" :precision="2" :min="0"></el-input-number>
                                <!-- <el-input v-model="formServeDetail.yijie_money" autocomplete="off"></el-input> -->
                            </el-form-item>
                        </el-col>
                        <el-col :span="8">
                            <el-form-item label="未结金额" prop="weijie_money" :rules="rule">
                                <el-input-number v-model="formServeDetail.weijie_money" :precision="2" :min="0"></el-input-number>
                                <!-- <el-input v-model="formServeDetail.weijie_money" autocomplete="off"></el-input> -->
                            </el-form-item>
                        </el-col>
                    </el-row>
                    <el-row>
...
<script>
import {
  getSupplieradvanceList,
  getSupplieradvanceDetail,
  addSupplieradvance,
  editSupplieradvance,
...
export default {
    ...
    methods:{
        ...
        editDone(formName) {
            this.$refs[formName].validate(valid => {
                ...
                if (this.isEdit) {
                    ...
                    editSupplieradvance(tmpData).then(res => {
                    if (res.errno == 0) {
                        this.$message({
                        type: "success",
                        message: "修改成功!",
                    ...
                    this.formServeDetail.check_time = parseInt(new Date() / 1000);
                    let tmpData = this.$qs.stringify(this.formServeDetail);
                    addSupplieradvance(tmpData).then(res => {
                    if (res.errno == 0) {
                        this.$message({
                        type: "success",
                        message: "添加成功!",
        ...
        showDetails(row){
            ...
            getSupplieradvanceDetail(data).then(res=>{
                if(res.errno == 0) {
                    this.formServeDetail = res.data
                    this.formServeDetail.money = res.data.money.substring(1);
                    this.formServeDetail.yijie_money = res.data.yijie_money.substring(1);
                    this.formServeDetail.weijie_money = res.data.weijie_money.substring(1);
                }
            })
        },
        checkRow(row) {
            ...
            .then(() => {
                ...
                checkSupplieradvance(tmpData).then(res=>{
                    if (res.errno == 0) {
                        this.$message({
                            type: "success",
                            message: "审核成功!",
