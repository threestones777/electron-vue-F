    ...
    <div class="barCodeManage">
        ...
        <div class="main-table">
            ...
            <el-form :inline="true" :model="formServe" class="demo-form-inline">
                <el-form-item label="">
                    <el-input v-model="formServe.name" placeholder="条码名称"></el-input>
                </el-form-item>
                <el-form-item label="">
                    <el-input type="tel" v-model="formServe.marks" placeholder="条码内容"></el-input>
                </el-form-item>
                <el-form-item label="">
                    <el-select v-model="value" placeholder="条码类型">
                        <el-option
            ...
            <!-- 图像弹出框 -->
            <el-dialog width="450px" title="条码图像" :visible.sync="dialogPic">
            ...
            style="width: 100%">
                ...
                width="240">
                    <template slot-scope="scope">
                        <el-button type="text" size="small" @click="dialogPic = true">图像</el-button>
