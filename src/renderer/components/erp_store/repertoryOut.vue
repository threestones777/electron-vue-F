  ...
  <div id="repertoryOut">
    ...
    <div class="main-table">
            ...
            <el-form :inline="true" :model="formServe" class="demo-form-inline">
                ...
                <el-form-item>
                    <el-input placeholder="请输入提交货人" @input="search" v-model="keywords" style="width:50%;margin-right:10px" size="small">
            ...
            <el-dialog width="900px" title="增改商品" :visible.sync="dialogServeAdd">
                ...
                <el-popover
                    ...
                    <el-button :disabled="bn_goodsList.inout_status!=2" class="btn-t" slot="reference" @click="getList" type="primary" size="small">新增商品</el-button>
                </el-popover>
                <el-table
					:data="bn_goodsList"
					border
                    ...
                    <el-row>
                        ...
                        <el-col :span="8">
                            <el-form-item label="类型">
                                <el-input disabled v-model="formServeDetail.inout_type_name" autocomplete="off"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="8">
			...
			<el-dialog width="600px" title="提交货人选择" :visible.sync="dialogDataClerk">
				...
				<el-button class="btn-b" type="primary" @click="getClerkDone" size="small">确认</el-button>
			</el-dialog>
...
export default {
    ...
    methods:{
        search() {
            getOtsaleList({params:{takegoods_man:this.keywords}}).then(res => {
        ...
        initData(obj) {
            ...
            getOtsaleList({params:data}).then(res => {
                console.log(res.data);
                if (res.errno == 0) {
                this.Data = res.data.arr;
                this.total = Number(res.data.record_count);
        ...
        addGoods(v) { // 获取单据内商品列表
            ...
            getOtsaleDetail({params:data}).then(res=>{
                console.log(res)
                if(res.errno == 0) {
        ...
        deleteGoods(row) { // 删除单据内商单个商品
            ...
            delOtsaleGoods(tmpData).then(res=>{
                if(res.errno ==0) {
                    this.$message({
                        type: "success",
                        message: "删除成功!",
